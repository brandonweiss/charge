...
Clean URLs, or ”Directory Indexes” as they were more commonly called in the old days is a way of structuring static files such that the file extensions don’t show in the URL.
