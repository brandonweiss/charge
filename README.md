...
The function will be passed all the same props a template normally receives. Return a JavaScript object from the exported function and it will be stringified into JSON.
